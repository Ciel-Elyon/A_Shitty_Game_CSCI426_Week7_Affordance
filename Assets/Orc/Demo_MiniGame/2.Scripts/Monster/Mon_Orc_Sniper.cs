...
public class Mon_Orc_Sniper : Mon_Bass
{

   

    protected StateMachine<Mon_Orc_Sniper> _stateMachine = null;
    ...
    public override void Init()
    {
            ...
            _stateMachine = new StateMachine<Mon_Orc_Sniper>(this);
   ...
   protected void CreateArrow()
    {
      //  Debug.Log("아아아222아");
        ...
        if (Current_Tartget == null)
            ...
            GameObject tmpobj = Instantiate(Bullet, WeaponSocket.transform.position, WeaponSocket.transform.localRotation);
      //  Debug.Log("Tmp" + tmpobj);
            ...
            tmpobj.GetComponent<BulletScript>().Fire(Current_Tartget.transform.position,m_Damage);
    ...
    private class IdleState : State<Mon_Orc_Sniper>
    {
    ...
    private class RunState : State<Mon_Orc_Sniper>
    {
        protected override void Begin()
        {
    ...
    private class AttackState : State<Mon_Orc_Sniper>
    {
        protected override void Begin()
        {
            Owner.SetAnim("Demo_Attack_Riple");
    ...
    private class HitState : State<Mon_Orc_Sniper>
    {
        protected override void Begin()
        {
    ...
    private class DieState : State<Mon_Orc_Sniper>
    {
        protected override void Begin()
        {
